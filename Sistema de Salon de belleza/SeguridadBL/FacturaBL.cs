...
namespace BL.Rentas
{
    public class FacturaBL
    {
        ...
        public void RemoverFacturaDetalle(Factura factura, FacturaDetalle facturaDetalle) // remueve la factura
        {
        ...
        private Resultado Validar(Factura factura)
        {
            ...
            if (factura == null)
            {
                resultado.Mensaje = "Agrege una factura para poderla salvar";
            ...
            {
                resultado.Mensaje = "Agrege productos o servicios a la factura";
                resultado.Exitoso = false;
            }
